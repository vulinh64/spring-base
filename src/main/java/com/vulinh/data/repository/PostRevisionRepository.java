...
public interface PostRevisionRepository
    extends JpaRepository<PostRevision, PostRevisionId>,
        JpaSpecificationExecutor<PostRevision>,
        ListQuerydslPredicateExecutor<PostRevision>,
        QueryByExampleExecutor<PostRevision> {
