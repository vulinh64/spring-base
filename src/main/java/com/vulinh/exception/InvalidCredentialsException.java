 ...
 *
 * <p>This exception is typically thrown during login processes when provided credentials (such as
 * username/password or tokens) do not match expected values in the system. It extends {@link
