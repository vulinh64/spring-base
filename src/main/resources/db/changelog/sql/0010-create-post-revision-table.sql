...
(
    ...
    tags                       text NULL,
    revision_created_date_time timestamptz NULL,
...
CREATE INDEX post_revision_revision_created_date_idx ON post_revision USING btree (revision_created_date_time);
